 ...
 <div class="product-container"><!--Bắt đầu mục mua sản phẩm-->
     ...
     <div>
         ...
         <div class="additional-info">
             ...
             <span class="store-pickup"><i class='bx bxs-store'></i> <a href="http://localhost/wedbanhang/giaodien/controler/xl_giohang/giohang.php?id_sanPham=<?php echo $id_sanPham . '&trivot=' . $currentUrl; ?>">Thêm vào giỏ hàng</a>
             </span>
         </div>
     </div>
